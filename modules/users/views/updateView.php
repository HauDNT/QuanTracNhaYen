         ...
         <div class="modal-body">
            <form enctype="multipart/form-data" method="POST">
               ...
               <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="update-recipient-name" name="fullname" value="<?php if (!empty($user_info['fullname'])) echo $user_info['fullname']; ?>">
               </div>
               <div class="mb-3">
                  <label for="recipient-name" class="col-form-label">Username</label>
                  <input type="text" class="form-control" id="update-recipient-name" name="username" value="<?php if (!empty($user_info['username'])) echo $user_info['username']; ?>">
               </div>
               <div class="mb-3">
                  <label for="station-longtitude" class="col-form-label">Email</label>
                  <input type="email" class="form-control" id="station-longtitude" name="email" value="<?php if (!empty($user_info['email'])) echo $user_info['email']; ?>">
               </div>
               <div class="mb-3">
                  <label for="station-langtitude" class="col-form-label">Số điện thoại</label>
                  <input type="text" class="form-control" id="station-langtitude" name="phone_number" value="<?php if (!empty($user_info['phone_number'])) echo $user_info['phone_number']; ?>">
               </div>
               <div class="mb-3">
                  <label for="station-langtitude" class="col-form-label">Ngày sinh</label>
                  <input type="text" class="form-control" id="station-langtitude" name="birthday" value="<?php if (!empty($user_info['birthday'])) echo $user_info['birthday']; ?>">
               </div>
               <div class="mb-3">
