...
<body>
    <!-- Navbar -->
    <nav class="d-flex align-items-center bg-white shadow-sm justify-content-between px-2">
        <div class="logo d-flex align-items-center">
            <button class="menu-button btn border-0 p-2 py-1" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
