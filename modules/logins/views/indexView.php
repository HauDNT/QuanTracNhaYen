...
<body>
  <div class="login-page container-fluid p-0 vh-100 d-flex align-items-center">
    <div class="login-form mx-auto d-flex flex-wrap justify-content-center">
      <img src="public/img/Login-bg.jpg" alt="" height="360px" class="me-0 me-sm-5">
      <div class="card border-0 align-self-start">
        ...
        <div class="card-body py-0">
          <div class="input-group mb-3 rounded-3 shadow-sm">
            <i class="bi bi-person fs-4 text-primary py-2 ps-3 border-0 rounded-start-3"></i>
            <div class="form-floating">
              <input type="text" class="form-control border-0 shadow-none" id="username" placeholder="Tài khoản">
        ...
        <div class="card-footer border-0 bg-transparent">
          <div id="notify-error" class="text-danger mb-1">
            <i class="bi bi-exclamation-circle-fill d-none"></i>
            <span></span>
          </div>
          <a href="?mod=forgot_password" class="text-decoration-none d-inline-block border-0 text-primary mb-3">Quên mật khẩu ?</a>
          <button id="sign-in-submit" class="btn btn-primary w-100">Đăng nhập</button>
        </div>
      </div>
    </div>
  </div>
