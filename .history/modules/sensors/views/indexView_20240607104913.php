...
<div class="modal fade" id="addSensorModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form class="modal-content" enctype="multipart/form-data" method="POST" action="?mod=sensors&action=addSensor">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="recipient-name" name="id_sensor" value="1">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="recipient-name" name="position_sensor" value="1" min="1">
                </div>
            </div>
