<div class="sidebar offcanvas offcanvas-start p-2 me-2" id="sidebar-user" aria-labelledby="sidebar-userLabel">
    ...
    <div class="offcanvas-body px-0">
        <ul class="lists list-inline">
            ...
            <li class="list">
                <a href="?mod=users&action=logout&controller=login" class="nav-link">
                    <i class="bx bxs-cog icon"></i>
