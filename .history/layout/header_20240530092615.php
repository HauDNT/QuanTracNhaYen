...
<body>
    <!-- Navbar -->
    <nav class="d-flex align-items-center bg-white shadow-sm justify-content-between">
        <div class="logo d-flex align-items-center px-2">
            ...
            <div class="logo-name d-flex flex-column">
                ...
                <span class="ms-2 text-secondary">Hệ thống giám sát nhiệt độ, độ ẩm nhà yến</span>
            </div>
        </div>
