                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center">
                                <a href="?mod=sensors&action=updateSensor&views=update&id=<?= $sensor['id'] ?>" class="text-light btn btn-warning me-3 btn-xs sharp update-modal" role="btn" data-bs-toggle="modal" data-bs-target="#updateSensorModal">
                                    <i class='bx bx-edit-alt h-1'></i>
                                </a>
