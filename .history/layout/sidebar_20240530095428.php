    <!-- Sidebar -->
    <div class="sidebar offcanvas offcanvas-start p-2" tabindex="-1" id="sidebar-user" aria-labelledby="offcanvasExampleLabel">
        <div class="logo d-flex align-items-center">
            <button class="menu-button btn border-0 p-0 px-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
            </button>
            <button type="button" class="menu-button btn border-0 p-0 px-2" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        ...
        <div class="offcanvas-body px-0">
            <ul class="lists list-inline">
                ...
                <li class="list">
                    <a href="?mod=sensors" class="nav-link">
