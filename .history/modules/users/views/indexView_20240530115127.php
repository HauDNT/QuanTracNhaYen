...
<div class="main-page container-xxl d-flex p-0">
    ...
    <div class="content mt-2">
        ...
        <div class="row g-0 d-flex">
            <button type="button" class="btn w-auto ms-auto" data-bs-toggle="modal" data-bs-target="#addUserModal" data-bs-whatever="@mdo">
                <a type="button" href="?mod=users&action=addUser&views=add" class="btn btn-primary ms-auto" data-bs-toggle="modal" data-bs-target="#addUserModal" data-bs-whatever="@mdo">
