...
<div class="main-page container-xxl d-flex p-0">
    ...
    <div class="content mt-2">
        <div class="row g-0">
            ...
            <div class="w-auto ms-auto">
                <button type="button" class="btn btn-primary ms-auto" data-bs-toggle="modal"
                    data-bs-target="#addPositionModal" data-bs-whatever="@mdo">
        ...
        ?>
        <div id="successToast" class="toast position-fixed top-50 start-50 translate-middle" role="alert"
            style="z-index: 9999;" aria-live="polite" aria-atomic="true">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            <a href="?mod=position&action=updatePosition&views=update&id=<?php echo $position['id'] ?>"
                                class="text-light btn btn-warning shadow me-3 btn-xs sharp"><i
                                    class='bx bx-edit-alt h-1'></i></a>
                            <a href="?mod=position&action=deletePosition&id=<?php echo $position['id'] ?>"
                                class="btn btn-danger shadow btn-xs sharp"
                                onclick="return confirm('Bạn muốn xoá tầng này?')">
...
<!-- Modal add Sensor-->
<div class="modal fade" id="addPositionModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-body">
                <form enctype="multipart/form-data" method="POST" action="?mod=position&action=addPosition">
                    ...
                    <div class="mb3 mt-8 d-flex modal-footer">
                        <button type="button" class="btn btn-secondary ms-auto mr-4" data-bs-dismiss="modal">Trở
                            lại</button>
