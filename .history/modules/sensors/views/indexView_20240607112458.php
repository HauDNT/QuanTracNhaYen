                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center">
                                <a href="?mod=sensors&action=updateSensor&views=update&id=<?= $sensor['id'] ?>" class="text-light btn btn-warning me-3 btn-xs sharp update" role="btn" data-bs-toggle="modal" data-bs-target="#addSensorModal">
