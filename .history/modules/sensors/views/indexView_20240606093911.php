                ...
                <?php foreach ($list_sensor as $index => $sensor) : ?>
                    <tr>
                        ...
                        <td class="text-center d-flex justify-content-center">
                            <a href="?mod=sensors&action=updateSensor&views=update&id=<?= $sensor['id'] ?>" class="text-light btn border-0 me-3 btn-xs sharp"><i class='bx bx-edit-alt h-1 text-warning'></i></a>
